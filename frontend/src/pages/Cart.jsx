                        ...
                        if (cartItems[e.id] > 0) {
                            return (
                                <tr key={e.id} className='border-b border-slate-900/20 text-gray-30 p-6 medium-14 text-center'>
                                    ...
                                    <td>
                                        <div className='bold-22 pl14'><TbTrash onClick={() => removeFromCart(e.id)} /></div>
                                    </td>
                                </tr>
                            );
                        }
                ...
                <div className='flex flex-col gap-10'>
                    ...
                    <div>
                        <div className='flexBetween py-4'>
                            ...
                            <h4 className='text-gray-30 font-semibold'>₹{calculateSubtotal()}</h4>
                        </div>
                        <hr />
                        <div className='flexBetween py-4'>
                        ...
                        <div className='flexBetween py-4'>
                            ...
                            <h4 className='bold-18'>₹{calculateSubtotal()}</h4>
                        </div>
                    </div>
                    <button className='btn_dark_rounded w-44'>Checkout</button>
                    <div className='flex flex-col gap-10'>
                        <h4 className='bold-20 capitalize'>Your coupon code enter here:</h4>
                        <div className='flexBetween p1-5 h-12 bg-primary rounded-full ring-1 ring-slate-900/10'>
